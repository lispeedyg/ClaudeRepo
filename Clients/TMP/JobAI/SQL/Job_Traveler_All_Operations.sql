-- ========================================================================
-- JOB TRAVELER - ALL OPERATIONS VIEW
-- Purpose: Foundational query for JobAI - provides complete job context
-- This query returns ALL operations for a specific job as the opening set
-- of facts for AI analysis and dashboard display
-- ========================================================================
...
DECLARE @JobNumber VARCHAR(50) = '1317608'

-- ========================================================================
-- MAIN QUERY: Complete Job Traveler Information
-- This provides the comprehensive view of job status as shown in the
-- debug screenshot - all operations regardless of cleanup status
-- ========================================================================
SELECT 
    j.Job,
    j.Customer,
...
-- ========================================================================
-- USAGE IN JobAI APPLICATION:
-- 
-- This query provides the foundational "opening set of facts" for JobAI
-- analysis. The data returned should be displayed in tabular form at the
-- top of the JobAI interface, providing context for all subsequent analysis.
-- 
-- Key Data Points Provided:
-- 1. Job Header: Job number, customer, part number, overall status
-- 2. Operation Details: All operations with sequence, work center, status
-- 3. Time Tracking: Hours worked, quantities, last activity, operators
-- 4. Status Intelligence: Cleanup warnings, action items
-- 
-- Integration Points:
-- - Backend API: Create endpoint /api/job-traveler/:jobNumber
-- - Frontend: Display as expandable table above AI analysis
-- - AI Context: Include this data in Claude prompts for job analysis
-- ========================================================================
